...
#Kao krajnje taˇcke (x1 i x3) možemo uzeti granice intervala, dok srednju taˇcku
#(x2) možemo postaviti na aritmetiˇckoj
#sredini ove dve taˇcke. Dakle, taˇcke
#trebaju da budu rasporedene na slede´ci ¯
#naˇcin: x1 < x2 < x3.
#apomena: Moramo proveriti da li je
#zadovoljena relacija: f(x1) ≥ f(x2) ≤
#f(x3).
